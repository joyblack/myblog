...
<!-- 配置块扫描器间隔多久时间检测块，以应对可能的磁盘故障。默认值504小时，三周。通过`http:/datanode:50075/blockScannerReport`可访问相关信息。-->
<property>
  <name>dfs.namenode.resource.checked.volumes.minimum</name>
  <value>1</value>dfs.datanode.scan.period.hours
  <description>
...
<!-- 均衡器(start-balancer.sh)在后台运行时，在不同节点之间复制数据的带宽，单位为字节B，默认为1M/S。  -->
<property>
